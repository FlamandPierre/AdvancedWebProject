package com.spring.henallux.AdvancedWebProject.configuration;
...
public class WebSecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    private static final String[] AUTHORIZED_REQUESTS_ANYBODY = new String[]{"/css/**", "/images/**", "/home/**", "/signUp/**", "/login/**", "/checkout/**", "/item/**", "/category/**", "/about_us/**"};
